...
function RegistrationsCreate() {
    ...
    let onSave = () => {
		update(() => {
			...
			backend.post<RegistrationModel>(`http://localhost:5226/api/events/${locationParams["eventId"]}/competitions/${locationParams["competitionId"]}/registrations`, entity)
			//success
			.then(resp => {
		...
		<div className="d-flex flex-column h-100 overflow-auto">
			<div className="d-flex justify-content-center">
				<div className="d-flex flex-column align-items-start" style={{width: "80ch"}}>					
                    ...
                    <label htmlFor="description" className="form-label" style={{color: "white"}}>Markė:</label>
					<InputText 
						id="description" 
